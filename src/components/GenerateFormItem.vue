<template>
  <div>
    <el-form-item v-if="widget.type == 'divider'" label-width="0px" :prop="widget.model">
      <el-divider :content-position="widget.options.contentPosition">{{dataModel}}</el-divider>
    </el-form-item>

    <el-form-item :label="widget.name" :prop="widget.model" v-else>
